...
img_path = "../DataSet/VOC2007+2012/Train/JPEGImages/000008.jpg"
...
img = cv2.imread(img_path)
h, w, _ = img.shape
txt_path = "../DataSet/COCO2017/Train/train-Labels/000000397973.txt"
coords = []
cv2.imshow("original", img)
cv2.waitKey(1000)
...
print(coords)
'''
#box:0.9999999999999964 0.0 anchor:350 330 coord:[0.4831730769230769, 0.5336538461538461, 0.4855769230769231, 0.5336538461538461, 14] txt_path:../DataSet/COCO2017/Train/train-Labels/000000397973.txt seed:2