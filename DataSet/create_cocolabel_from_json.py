...
if __name__ == "__main__":
    ...
    parser.add_argument('--json_file', type=str, default='/home/jin-ming/CV_DataSet/COCO2017/annotations/instances_val2017.json')
    parser.add_argument('--class_file', type=str, default='./COCO2017/class.txt')
    parser.add_argument('--imgs_path', type=str, default='/home/jin-ming/CV_DataSet/COCO2017/images')
    ...
    with open(args.json_file, 'r') as json_content:
        ...
        for image_id in labels_dict.keys():
            ...
            target_img_path = os.path.join(args.target_labels_path.replace("/Labels", "/Images"))
