...
if __name__ == "__main__":
    ...
    parser.add_argument('--target_train_pth', type=str, default='./YOLOv3/DataSet/VOC2007+2012/Train')
    parser.add_argument('--target_val_pth', type=str, default='./YOLOv3/DataSet/VOC2007+2012/Val')
