# ---------------step1:Dataset 数据集-------------------
import torch
from COCO_DataSet import VOCDataSet
...
#dataSet = VOCDataSet(imgs_dir="./VOC2007/Val/JPEGImages", annotations_dir="./VOC2007/Val/Annotations", ClassesFile="./VOC2007/Train/class.data")
